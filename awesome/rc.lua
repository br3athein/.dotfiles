...
globalkeys = gears.table.join(
    ...
    -- Touchpad control
    awful.key({ }, "XF86TouchpadToggle", function () awful.util.spawn("touchpad-toggle") end),
...
for i, keycode in pairs({ 19, 30, 31, 32, 33, 57, 58, 16, 17, 18 }) do
  --      Matching keys:   0,  U,  I,  O,  P,  N,  M,  7,  8,  9
